...
class AttendanceReportController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $results->getCollection()->transform(function ($record) use ($leaveMap, $date) {
            ...
            // New logic: Check if late is within 30 min grace period
            $isGracePeriodLate = $isLate && ($lateMinutes <= 30);
            ...
            return [
                ...
                'is_late' => $isLate && !$isGracePeriodLate, // Only true if > 30 mins
    ...
    public function monthly(Request $request)
    {
        ...
        foreach ($grouped as $employeeId => $records) {
            ...
            $monthlyLateCount = $records->filter(function ($r) {
                ...
                if ($isLate) {
                    $mins = $this->getLateMinutes($r->in_time, '09:00:00');
                    return $mins > 30; // Only count if greater than 30
                }
                return false;
            })->count();
            ...
            foreach ($records as $record) {
                ...
                if ($isLate && !$isGracePeriodLate) { // Only update summary for actual lates
